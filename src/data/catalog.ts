...
export const products: Product[] = [
  {
    ...
    description:
      "Full-length CUET UG mock tests, domain-wise practice, English, General Test, percentile benchmarking, and detailed solutions built around the latest NTA pattern.",
    price: 1499,
    compareAtPrice: 2499,
    mocks: 45,
    students: "2,100+",
  ...
  },
  {
    ...
    description:
      "Research-aptitude mocks across Physics, Chemistry, Mathematics, and Biology with calibrated difficulty and all-India rank prediction.",
    price: 1299,
    compareAtPrice: 2199,
    mocks: 30,
    students: "1,400+",
    ...
    features: [
      "30 complete IAT mocks",
      "PCMB analytics",
      "AIR prediction",
      "Faculty solutions",
    ],
    keywords: [
      "IISER IAT mock test 2026",
      "IAT test series",
      "IISER aptitude test mocks",
      "IAT online practice",
    ],
  },
  {
    ...
    description:
      "NEST mock tests designed for NISER and CEBS aspirants, with section strategy, advanced problem sets, and step-by-step explanations.",
    price: 999,
    compareAtPrice: 1699,
    mocks: 24,
    students: "680+",
    ...
    keywords: [
      "NISER NEST mock test 2026",
      "NEST online test series",
      "NISER entrance mock",
      "NEST practice questions",
    ],
  },
  {
    ...
    description:
      "Timed COMEDK UGET mocks, high-speed PCM drills, chapter analytics, and percentile estimates for Karnataka engineering admissions.",
    price: 1199,
    compareAtPrice: 1999,
    mocks: 35,
    students: "910+",
